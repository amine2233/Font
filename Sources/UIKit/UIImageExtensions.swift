...
extension UIImage {
    ...
    /// - parameter backgroundColor: The background color (optional).
    /// - returns: A UIImage that will appear as icon with FontAwesome
    private static func fontConfigure(_ font: FontConvertible, name: String, textColor: UIColor, size: CGSize, backgroundColor: UIColor, borderWidth: CGFloat = 0, borderColor: UIColor = UIColor.clear) -> UIImage? {
