...
public extension UIImage {
    ...
    public static func fontAwesome(with name: FontAwesome, textColor: UIColor, size: CGSize, backgroundColor: UIColor = .clear) -> UIImage {
        ...
        paragraph.alignment = NSTextAlignment.center
        let fontSize = min(size.width, size.height)
        let fontsAttributes = [NSAttributedStringKey.font: Font(font: FontFamily.FontAwesome.medium, size: fontSize), NSAttributedStringKey.foregroundColor: textColor, NSAttributedStringKey.backgroundColor: backgroundColor, NSAttributedStringKey.paragraphStyle: paragraph]
