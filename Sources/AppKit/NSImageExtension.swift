...
extension NSImage {
    ...
    public static func font<T: FontFamily>(_ font: T, textColor: NSColor, size: CGSize, backgroundColor: NSColor = NSColor.clear, edgeInsets: NSEdgeInsets = NSEdgeInsetsZero) -> NSImage? {
        return NSImage.fontConfigure(T.regularFont, with: String.fontConvertible(with: font.name), size: size, textColor: textColor, backgroundColor: backgroundColor, edgeInsets: edgeInsets)
    }
